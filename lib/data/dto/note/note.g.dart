...
extension GetNoteDtoCollection on Isar {
  IsarCollection<NoteDto> get notes => this.collection();
}

const NoteDtoSchema = CollectionSchema(
  name: r'NoteDto',
  id: -5910115709183681911,
  properties: {
...
extension NoteDtoQueryFilter
  ...
  QueryBuilder<NoteDto, NoteDto, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteDto, NoteDto, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
